...
<html>
	...
	<body>
		<div id="top_bottom">
			<div class="intro_top">
				...
				<span id="top_user">
					...
					<a href="###">${sessionUser.susername}</a>
				</span>
			</div>
		</div>
		<div class="intro_main">
			...
			<!-- form start  -->
			<s:form action="student_writeResume.action">
					...
					<div class="###">
						<form action="" method="">
							<span>
								...
								<input type="text" id="stuInfo.infoName" name="name"/>
							</span>
							<span>
								<label class="row_one_label">性　别</label>
								<input type="radio" name="stuInfo.infoSex" id="sex1" value="1" checked="checked"/>
							...
							<span>
								...
								<input type="text" id="birth_time" name="stuInfo.infoBirthday" class="generic_time"/>
							</span>
				
							<span>
								<label for="addr_home" class="row_one_label">家庭住址</label>
								<input type="text" id="addr_home" name="stuInfo.birthdayPlace"/>
							</span>
							<span>
