				...
				<div id="box2" class="per_aim info_common">
					...
					<div>
						<form action="" method="post">
							...
							<span>
								<label class="wish-city">长期出差意愿</label><input type="radio" name="btrip" id="btrip1" value="1" />
								<label for="btrip1">有</label>
								<input type="radio" name="btrip" id="btrip2" value="0" checked="checked"/>
								<label for="btrip2">无</label>
							</span>
							<span>
